...
public class DrawChart extends View {
	...
	private int OFFSET_TOP = 1;
	private int X_INTERVAL = 15;
	...
	private void drawTable(Canvas canvas){
		...
		Rect chartRec = new Rect(OFFSET_LEFT, OFFSET_TOP,CHARTW+OFFSET_LEFT, CHARTH+OFFSET_TOP-60);
		...
		canvas.drawTextOnPath("", textPath, 0, 0, paint);
		canvas.drawTextOnPath("", textPath, 100, 10, paint);
        //畫表格中的虛線
        Path path = new Path();     
